...
declare module "@oomol-lab/connector" {
  interface ActionRegistry {
    /** Delete one IMAP Mailbox message from a folder. */
    "generic_imap.delete_email": {
      input: {
        /**
    ...
    /** Download one IMAP Mailbox attachment by IMAP body part identifier. */
    "generic_imap.download_attachment": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Forward one IMAP Mailbox email using SMTP with quoted original content. */
    "generic_imap.forward_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Fetch and parse one IMAP Mailbox message without marking it as read. */
    "generic_imap.get_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Get lightweight message counters for one IMAP Mailbox folder. */
    "generic_imap.get_folder_status": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** List folders visible to the connected IMAP Mailbox account. */
    "generic_imap.list_folders": {
      input: Record<string, never>;
      output: {
        /** The folders returned by IMAP Mailbox IMAP. */
        folders: Array<{
          /**
    ...
    /** Mark one IMAP Mailbox message as read. */
    "generic_imap.mark_email_read": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Mark one IMAP Mailbox message as unread. */
    "generic_imap.mark_email_unread": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Move one IMAP Mailbox message to another folder. */
    "generic_imap.move_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Reply to one IMAP Mailbox email using SMTP reply headers and quoted content. */
    "generic_imap.reply_email": {
    ...
    /** Search one IMAP Mailbox folder and return lightweight email summaries. */
    "generic_imap.search_emails": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Send an email through IMAP Mailbox SMTP. */
    "generic_imap.send_email": {
      input: Record<string, unknown>;
      output: {
        /** The SMTP Message-ID returned by the mail client. */
        messageId: string | null;
