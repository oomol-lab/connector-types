...
declare module "@oomol-lab/connector" {
  interface ActionRegistry {
    /** Delete one NetEase Enterprise Mail message from a folder. */
    "netease_enterprise_mail.delete_email": {
      input: {
        /**
    ...
    /** Download one NetEase Enterprise Mail attachment by IMAP body part identifier. */
    "netease_enterprise_mail.download_attachment": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Forward one NetEase Enterprise Mail email using SMTP with quoted original content. */
    "netease_enterprise_mail.forward_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Fetch and parse one NetEase Enterprise Mail message without marking it as read. */
    "netease_enterprise_mail.get_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Get lightweight message counters for one NetEase Enterprise Mail folder. */
    "netease_enterprise_mail.get_folder_status": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** List folders visible to the connected NetEase Enterprise Mail account. */
    "netease_enterprise_mail.list_folders": {
      input: Record<string, never>;
      output: {
        /** The folders returned by NetEase Enterprise Mail IMAP. */
        folders: Array<{
          /**
    ...
    /** Mark one NetEase Enterprise Mail message as read. */
    "netease_enterprise_mail.mark_email_read": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Mark one NetEase Enterprise Mail message as unread. */
    "netease_enterprise_mail.mark_email_unread": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Move one NetEase Enterprise Mail message to another folder. */
    "netease_enterprise_mail.move_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Reply to one NetEase Enterprise Mail email using SMTP reply headers and quoted content. */
    "netease_enterprise_mail.reply_email": {
    ...
    /** Search one NetEase Enterprise Mail folder and return lightweight email summaries. */
    "netease_enterprise_mail.search_emails": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Send an email through NetEase Enterprise Mail SMTP. */
    "netease_enterprise_mail.send_email": {
      input: Record<string, unknown>;
      output: {
        /** The SMTP Message-ID returned by the mail client. */
        messageId: string | null;
