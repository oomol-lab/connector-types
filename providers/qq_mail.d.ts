...
declare module "@oomol-lab/connector" {
  interface ActionRegistry {
    /** Delete one QQ Mail message from a folder. */
    "qq_mail.delete_email": {
      input: {
        /**
    ...
    /** Download one QQ Mail attachment by IMAP body part identifier. */
    "qq_mail.download_attachment": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Forward one QQ Mail email using SMTP with quoted original content. */
    "qq_mail.forward_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Fetch and parse one QQ Mail message without marking it as read. */
    "qq_mail.get_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
    ...
    /** Get lightweight message counters for one QQ Mail folder. */
    "qq_mail.get_folder_status": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** List folders visible to the connected QQ Mail account. */
    "qq_mail.list_folders": {
      input: Record<string, never>;
      output: {
        /** The folders returned by QQ Mail IMAP. */
        folders: Array<{
          /**
    ...
    /** Mark one QQ Mail message as read. */
    "qq_mail.mark_email_read": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Mark one QQ Mail message as unread. */
    "qq_mail.mark_email_unread": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Move one QQ Mail message to another folder. */
    "qq_mail.move_email": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
    ...
    /** Reply to one QQ Mail email using SMTP reply headers and quoted content. */
    "qq_mail.reply_email": {
    ...
    /** Search one QQ Mail folder and return lightweight email summaries. */
    "qq_mail.search_emails": {
      input: {
        /**
         * The IMAP folder path returned by list_folders.
         * @minLength 1
    ...
    /** Send an email through QQ Mail SMTP. */
    "qq_mail.send_email": {
      input: Record<string, unknown>;
      output: {
        /** The SMTP Message-ID returned by the mail client. */
